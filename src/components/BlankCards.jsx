...
const BlankCards = () => {
  ...
  return (
    <div className="relative">
      <GalaxyBackground />
      <div className="w-full h-full relative cursor-crosshair flex items-center justify-center  py-5">
        <div className="w-[1200px] h-[1200px] grid grid-cols-5 grid-rows-5 gap-5 bg-[#000814]">
          {/* Exploring section */}
          <div
  ...
  shadow-[inset_0_0_15px_#003566]"
          ...
          {/* <div className="bg-gradient-to-b from-[#1c1a73] to-[#000000] hover:animate-[blink_1s_infinite] hover:scale-101 transition-transform duration-300 col-start-1 col-end-3 row-start-3 row-end-6 w-full h-full flex items-center justify-center rounded-xl shadow-[inset_0_0_15px_#003566]">
          <img src="src/assets/images/v882-kul-32-a.jpg" alt="" />
        </div> */}
          ...
          <div className="relative bg-gradient-to-b from-[#1c1a73] via-[#000814] to-[#000000] hover:animate-[blink_1s_infinite] hover:scale-101 transition-transform duration-300 col-start-1 col-end-3 row-start-3 row-end-6 w-full h-full flex justify-center rounded-xl shadow-[inset_0_0_15px_#003566] overflow-hidden">
            ...
            <div className="relative z-10 p-6 text-center pt-20">
              ...
              <p className="text-xl bg-gradient-to-b from-white to-[#FFC300] bg-clip-text text-transparent">
                ...
                applications Continuous Sliding Examples using modern frameworks
                and best practices.
              </p>
              <div>
                ...
                <div className="flex justify-center flex-wra gap-6 items-center">
            ...
            {/* Image blended at bottom (same as first card) */}
            <img
              src="src/assets/images/lanscape_perspective_grid.jpg"
              alt="blended"
              className="absolute bottom-0 left-0 w-full h-1/2 object-cover rounded-b-xl shadow-[inset_0_0_15px_#003566]"
              style={{
                // mixBlendMode: "darken",
                maskImage:
                  "linear-gradient(to top, black 0%, transparent 100%)",
